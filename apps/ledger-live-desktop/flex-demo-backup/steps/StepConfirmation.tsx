...
function StepConfirmation({
  ...
  const flexModelId = isFlexBuild() ? getFakeDeviceModelId() : null;
  const successAnimation = flexModelId ? getDeviceAnimation(flexModelId, theme, "confirmLockscreen") : null;
  ...
  if (optimisticOperation) {
    return (
      <Container>
        ...
        {successAnimation && (
          <Box mb={3}>
            <Animation animation={successAnimation} loop={false} />
          </Box>
        )}
        <SuccessDisplay
